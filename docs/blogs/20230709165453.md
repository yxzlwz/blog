...
![1688892123614](../images/27c7574bbda34678488e91cf63dbf86a.png)

![1688892280212](../images/81139191d41e09324a8321ffc8fd6af2.png)

在新界面中下载 linux64 版本（复制链接，使用 wget 下载即可），然后解压缩，并复制到 `/usr/bin` 目录下以方便程序使用（如果不放入这个目录，则需要在后续的 Python 程序中手动指定 Driver 位置）

![1688892363032](../images/fc3bb2ca62da4677e9a5b1571a7d2445.png)
