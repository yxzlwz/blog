...
We define two basic operations for vectors.
...
Note that the addition is defined only for vectors of the same dimension.
...
::: note
The calculation can be applied to any matrices in the same way.
:::
