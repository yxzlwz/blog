...
Specifically, if $A$ is an upper triangular matrix or a lower triangular matrix, then the determinant of $A$ is the product of the entries on the main diagonal of $A$. That is,
